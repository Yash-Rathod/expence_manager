    ...
    return Scaffold(
      ...
      body: Container(
          ...
          child: StreamBuilder(
            ...
            builder: (ctxt, AsyncSnapshot<CategoryModel> categorySnap) {
              if (!categorySnap.hasData) return CircularProgressIndicator();
              return Column(
                children: <Widget>[
                  TextField(
                      ...
                      onChanged: (String text) {
                        ...
                        var category = categorySnap.data;
                  ...
                  Expanded(
                      child: Container(
                          ...
                          child: _showIconGrid(categorySnap.data))),
                  RaisedButton(
                    child: Text("Create"),
                    onPressed: categorySnap.data.title == null ? null : () async {
                      var createdId = await widget.categoryBloc.createNewCategory(categorySnap.data);
                      if(createdId > 0) {
